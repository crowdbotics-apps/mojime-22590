"""mojime_22590 URL Configuration
...
admin.site.site_header = "MojiMe"
admin.site.site_title = "MojiMe Admin Portal"
admin.site.index_title = "MojiMe Admin"

# swagger
api_info = openapi.Info(
    title="MojiMe API",
    default_version="v1",
    description="API documentation for MojiMe App",
)
